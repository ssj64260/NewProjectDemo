...
public class IndexBarDataHelper implements IIndexBarDataHelper {
     ...
     */
    @Override
    public IndexBarDataHelper convert(List<? extends BaseIndexPinyinBean> datas) {
     ...
     */
    @Override
    public IndexBarDataHelper fillInexTag(List<? extends BaseIndexPinyinBean> datas) {
        if (null == datas || datas.isEmpty()) {
            return this;
        }
        int size = datas.size();
    ...
    @Override
    public IndexBarDataHelper sortSourceDatas(List<? extends BaseIndexPinyinBean> datas) {
        if (null == datas || datas.isEmpty()) {
            return this;
        }
        convert(datas);
    ...
    @Override
    public IndexBarDataHelper getSortedIndexDatas(List<? extends BaseIndexPinyinBean> sourceDatas, List<String> indexDatas) {
